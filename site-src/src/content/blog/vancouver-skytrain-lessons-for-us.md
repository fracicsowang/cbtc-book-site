---
title: "Vancouver SkyTrain (Canada): What US Agencies Should Learn From It"
slug: vancouver-skytrain-lessons-for-us
description: "An engineer's read of Vancouver SkyTrain — the world's first large-scale automated rapid transit network, four decades of GoA 4 operation, and the operational and procurement lessons US transit agencies should draw from a system continuously running across the border since 1985."
date: 2026-07-15
author: "Chunjun (Francisco) Wang"
category: agency-case-studies
tags: [CBTC, Vancouver SkyTrain, GoA 4, driverless, North American transit, Canada, Hitachi SelTrac]
...
![Vancouver SkyTrain has operated four decades of continuous Grade of Automation 4 revenue service across three lines and.](/blog/img/vancouver-skytrain-lessons-for-us-fig1.svg)
*<small>Vancouver SkyTrain has operated four decades of continuous Grade of Automation 4 revenue service across three lines and.</small>*
...
<figure class="blog-figure blog-figure--table">
  <table class="blog-table">
    <thead>
      <tr><th>Metric</th><th>Vancouver SkyTrain</th><th>Honolulu Skyline</th></tr>
    </thead>
    <tbody>
      <tr><td>Years of Operation</td><td>40+</td><td>Since 2023</td></tr>
      <tr><td>Grade of Automation</td><td>GoA 4</td><td>GoA 4</td></tr>
      <tr><td>Network Length (km)</td><td>80+</td><td>—</td></tr>
      <tr><td>System Availability</td><td>Aligns with international benchmarks</td><td>—</td></tr>
      <tr><td>Mean Time Between Failures</td><td>Higher than GoA 2 systems</td><td>—</td></tr>
      <tr><td>Public Acceptance</td><td>Not a meaningful issue</td><td>—</td></tr>
    </tbody>
  </table>
  <figcaption class="blog-figure__caption">Operational metrics from mature GoA 4 systems consistently exceed comparable GoA 2 deployments.</figcaption>
</figure>
...
This post is a 12-minute summary. The full treatment of US-relevant lessons from international benchmarks lives in Chapter 11 ("International Benchmarks") and Chapter 10 ("CBTC in the United States") of *Communications-Based Train Control* (Volume 2). [Buy on Amazon](https://www.amazon.com/dp/B0GYHLYQZZ). [Download Chapter 11 slides (free PDF)](https://cbtcbook.com/slides/cbtc_ch11.pdf).
...
- TransLink (Metro Vancouver). *SkyTrain Operations and Performance Reports*. [translink.ca](https://www.translink.ca/)

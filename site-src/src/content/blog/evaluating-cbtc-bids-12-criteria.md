...
![Best-value scoring across 12 criteria distinguishes proposals that low-bid scoring would treat as identical.](/blog/img/evaluating-cbtc-bids-12-criteria-fig1.png)
*<small>Best-value scoring across 12 criteria distinguishes proposals that low-bid scoring would treat as identical.</small>*
...
![Typical US CBTC bid evaluation weights — best-value, not low-bid, drives every recent major procurement.](/blog/img/evaluating-cbtc-bids-12-criteria-fig2.png)
*<small>Typical US CBTC bid evaluation weights — best-value, not low-bid, drives every recent major procurement.</small>*

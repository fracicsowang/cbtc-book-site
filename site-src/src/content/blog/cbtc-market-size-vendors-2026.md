---
title: "The CBTC Market in 2026: Size, Growth, and the Vendor Landscape"
slug: cbtc-market-size-vendors-2026
description: "A vendor-neutral read on the CBTC market in 2026 — why market-size estimates disagree by a factor of four, how Siemens, Alstom, Hitachi, and CRSC are positioned, and what is driving communications-based train control demand across China, the Gulf, India, Europe, and the United States."
date: 2026-08-22
author: "Chunjun (Francisco) Wang"
category: trends
tags: [CBTC, CBTC market, market size, vendors, Siemens Mobility, Alstom, Hitachi Rail, CRSC, train control market]
primary_keyword: "CBTC market"
secondary_keywords: ["CBTC market size", "CBTC vendors", "train control market", "communications based train control market"]
related_chapters: [15]
internal_links: ["/blog/why-madrid-has-more-cbtc-lines-than-us", "/blog/chinese-metro-cbtc-50-cities", "/blog/trainguard-mt-vs-urbalis-architecture"]
og_image: "/blog/img/cbtc-market-size-vendors-2026.png"
read_time: "10 min"
---

On 31 May 2024, Hitachi Rail closed its acquisition of Thales' Ground Transportation Systems business for roughly 1.66 billion euros, folding some 9,000 engineers and the SelTrac signaling family — the product that runs Vancouver, Dubai, and much of the London Underground — into a rail unit that now spans 51 countries and reports about 7.3 billion euros in pro-forma annual revenue ([Hitachi Rail, 2024](https://www.hitachi.com/en/press/articles/2024/05/0603a/)). For anyone tracking the CBTC market, that single close did more to reshape the competitive field than any technology release of the past decade. It reduced the population of full-line Communications-Based Train Control (CBTC) integrators, moved one of the most widely deployed product lines under a new owner, and confirmed a direction the industry had been drifting toward for years: fewer, larger prime suppliers, each carrying more than one CBTC product under its roof.
...
- One market-research estimate, from Fortune Business Insights, valued the communications-based train control market at roughly USD 9.5 billion in 2025, projecting growth to about USD 20 billion by 2034 at a compound annual growth rate near 8.7% ([Fortune Business Insights, 2025](https://www.fortunebusinessinsights.com/communication-based-train-control-market-106979)).
- Global Market Insights sized the same category far lower — around USD 2.4 billion in 2024 — while estimating a comparable growth rate of roughly 8.1% through 2034 ([Global Market Insights, 2025](https://www.gminsights.com/industry-analysis/communication-based-train-control-market)).
- Market Research Future put 2025 nearer USD 5.7 billion and forecast a steeper trajectory to about USD 16.9 billion by 2035 at roughly 11.5% ([Market Research Future, 2025](https://www.marketresearchfuture.com/reports/communication-based-train-control-market-12072)).
...
![Indicative regional growth-rate midpoints synthesized across several 2025-2026 market forecasts; directional, not precise shares. Asia-Pacific and the Gulf lead; US demand is real but funding-paced.](/blog/img/cbtc-market-size-vendors-2026-fig1.png)
*<small>Indicative regional growth-rate midpoints synthesized across several 2025-2026 market forecasts; directional, not precise shares. Asia-Pacific and the Gulf lead; US demand is real but funding-paced.</small>*
...
This post is a 10-minute market overview. The full treatment of the CBTC vendor landscape — how the primes are positioned, how consolidation has reshaped competition, and how to evaluate suppliers without locking into one — lives in Chapter 15 ("Vendor Landscape") of *Communications-Based Train Control*, Volume 2: Operations, Deployment & Economics ([Buy on Amazon](https://www.amazon.com/dp/B0GYHLYQZZ)). [Download Chapter 15 slides (free PDF)](https://cbtcbook.com/slides/cbtc_ch15.pdf) for the supplier-comparison framework.
...
- Hitachi Rail. (2024). *Hitachi Rail acquires Thales' Ground Transportation Systems*. [hitachi.com](https://www.hitachi.com/en/press/articles/2024/05/0603a/)
- GlobeNewswire / Hitachi Rail. (2024). *Hitachi Rail acquires Thales' Ground Transportation Systems for €1,660m*. [globenewswire.com](https://www.globenewswire.com/news-release/2024/05/31/2891676/0/en/Hitachi-Rail-acquires-Thales-Ground-Transportation-Systems-for-1-660m.html)
- Fortune Business Insights. (2025). *Communication-Based Train Control Market Size, Share [2034]*. [fortunebusinessinsights.com](https://www.fortunebusinessinsights.com/communication-based-train-control-market-106979)
- Global Market Insights. (2025). *Communication-Based Train Control Market Report, 2025-2034*. [gminsights.com](https://www.gminsights.com/industry-analysis/communication-based-train-control-market)
- Market Research Future. (2025). *Communication Based Train Control Market Size Report 2035*. [marketresearchfuture.com](https://www.marketresearchfuture.com/reports/communication-based-train-control-market-12072)
- Cognitive Market Research. (2026). *North America Communication Based Train Control (CBTC) System Industry Report*. [cognitivemarketresearch.com](https://www.cognitivemarketresearch.com/regional-analysis/north-america-communication-based-train-control-cbtc-system-market-report)
- Siemens Mobility / Trackopedia. (2025). *Siemens Mobility completes CBTC implementation on Paris metro line 14*. [trackopedia.com](https://www.trackopedia.com/en/news/all-countries/siemens-mobility-completes-cbtc-implementation-on-paris-metro-line-14)
- Alstom. (2025). *Alstom to supply trains, signalling solutions and maintenance for Mumbai Metro Line 4*. [alstom.com](https://www.alstom.com/press-releases-news/2025/8/alstom-supply-trains-signalling-solutions-and-maintenance-mumbai-metro-line-4)
- China Railway Signal and Communication (CRSC). *About CRSC — urban rail transit control technology and overseas contracting*. [crsc.cn](http://www.crsc.cn/g3175.aspx)
- MTA New York City Transit. (2025). *Proposed 2025-2029 Capital Plan (CBTC modernization)*. [mta.info](https://www.mta.info/press-release/mta-releases-proposed-2025-2029-capital-plan)

---
title: "Driverless Operations Worldwide: Who's GoA 4, Who's Faking It"
slug: driverless-operations-worldwide-goa-4
description: "A practitioner read of which metro systems globally actually operate at Grade of Automation 4 — fully unattended train operation — and which describe themselves as driverless while retaining attendants on board. The distinction matters for US transit agencies setting GoA targets."
date: 2026-07-07
author: "Chunjun (Francisco) Wang"
category: international-benchmarks
tags: [CBTC, GoA 4, driverless, UTO, unattended train operation, Paris Métro, Singapore MRT, Honolulu Skyline, Copenhagen Metro, international]
...
![Approximately 75–80 lines globally operate at full UTO. The rest are GoA 3 or lower, regardless of marketing.](/blog/img/driverless-operations-worldwide-goa-4-fig1.svg)
*<small>Approximately 75–80 lines globally operate at full UTO. The rest are GoA 3 or lower, regardless of marketing.</small>*
...
<figure class="blog-figure blog-figure--table">
  <table class="blog-table">
    <thead>
      <tr><th>GoA Grade</th><th>On-board Staff Role</th><th>Platform Screen Doors</th><th>Labor Cost per Train-km</th><th>Safety Case</th></tr>
    </thead>
    <tbody>
      <tr><td>GoA 2</td><td>Driver in the cab</td><td>—</td><td>—</td><td>Driver supervision</td></tr>
      <tr><td>GoA 3</td><td>Staff member on board</td><td>—</td><td>Higher than GoA 4</td><td>On-board staff role</td></tr>
      <tr><td>GoA 4</td><td>No on-board staff</td><td>Full-height platform screen doors</td><td>Lower than GoA 3</td><td>Automated systems</td></tr>
    </tbody>
  </table>
  <figcaption class="blog-figure__caption">GoA 2, GoA 3, and GoA 4 are different products with different cost and safety case implications.</figcaption>
</figure>
...
This post is an 11-minute summary. The full treatment of Grades of Automation, including the catalog of operational GoA 4 systems and the comparative safety case framework, lives in Chapter 8 ("Grades of Automation") and Chapter 11 ("International Benchmarks with US Relevance") of *Communications-Based Train Control* (Volume 2). [Buy on Amazon](https://www.amazon.com/dp/B0GYHLYQZZ). [Download Chapter 8 slides (free PDF)](https://cbtcbook.com/slides/cbtc_ch08.pdf).
...
- IEC (International Electrotechnical Commission). *IEC 62290: Railway Applications — Urban Guided Transport Management and Command/Control Systems*. [iec.ch](https://www.iec.ch)
- Régie Autonome des Transports Parisiens (RATP). *Lines 1 and 14 Operations*. [ratp.fr](https://www.ratp.fr)
- Land Transport Authority (LTA), Singapore. *MRT GoA 4 Lines*. [lta.gov.sg](https://www.lta.gov.sg)
- Metroselskabet Copenhagen. *M1/M2/M3/M4 Operations*. [m.dk](https://www.m.dk)
- Roads and Transport Authority (RTA), Dubai. *Dubai Metro Operations*. [rta.ae](https://www.rta.ae)
- Honolulu Authority for Rapid Transportation (HART). *Skyline Operations*. [honolulutransit.org](https://www.honolulutransit.org)
- TransLink (Vancouver). *SkyTrain Operations*. [translink.ca](https://www.translink.ca)
- IEEE Standards Association. *IEEE Std 1474.1: Standard for Communications-Based Train Control (CBTC) Performance and Functional Requirements*.
- Railway Gazette International. *Coverage of Driverless Metro Deployments*. [railwaygazette.com](https://www.railwaygazette.com)

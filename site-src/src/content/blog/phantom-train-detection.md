...
![Phantom train mechanisms and the defense layers that catch them. The architecture pattern is defense in depth — no singl.](/blog/img/phantom-train-detection-fig1.svg)
*<small>Phantom train mechanisms and the defense layers that catch them. The architecture pattern is defense in depth — no singl.</small>*

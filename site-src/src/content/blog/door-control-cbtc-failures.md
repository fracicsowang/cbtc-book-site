...
![The vital permission gates the action; the non-vital command layer adds operational context; the field layer executes. E.](/blog/img/door-control-cbtc-failures-fig1.svg)
*<small>The vital permission gates the action; the non-vital command layer adds operational context; the field layer executes. E.</small>*

...
![Four contractual layers that, used together, reduce CBTC vendor lock-in to a manageable residual.](/blog/img/cbtc-rfp-vendor-lockin-fig1.svg)
*<small>Four contractual layers that, used together, reduce CBTC vendor lock-in to a manageable residual.</small>*
...
![Bundled and unbundled CBTC procurement each preserve different forms of competitive leverage. The right answer depends o.](/blog/img/cbtc-rfp-vendor-lockin-fig2.svg)

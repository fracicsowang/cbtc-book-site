...
![SFMTA TCUP phased deployment from Central Subway through full system commissioning.](/blog/img/sfmta-muni-tcup-2024-rfp-fig1.svg)
*<small>SFMTA TCUP phased deployment from Central Subway through full system commissioning.</small>*
...
![Single-vendor (SFMTA) versus multi-vendor (MTA) procurement structures impose different lifecycle tradeoffs.](/blog/img/sfmta-muni-tcup-2024-rfp-fig2.svg)
*<small>Single-vendor (SFMTA) versus multi-vendor (MTA) procurement structures impose different lifecycle tradeoffs.</small>*

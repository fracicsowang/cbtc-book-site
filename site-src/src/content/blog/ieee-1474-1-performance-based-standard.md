...
![IEEE 1474.1 mandates performance outcomes; the supplier owns the design decisions that produce them.](/blog/img/ieee-1474-1-performance-based-standard-fig1.svg)
*<small>IEEE 1474.1 mandates performance outcomes; the supplier owns the design decisions that produce them.</small>*

...
![PTP delivers the network distribution; holdover oscillators provide the GNSS-loss fallback. Neither alone satisfies the.](/blog/img/time-synchronization-cbtc-gps-not-enough-fig1.svg)
*<small>PTP delivers the network distribution; holdover oscillators provide the GNSS-loss fallback. Neither alone satisfies the.</small>*

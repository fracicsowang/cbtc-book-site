...
![Dubai grew one homogeneous GoA 4 network to roughly 90 route-km on a single Thales SelTrac CBTC platform, without a legacy cutover.](/blog/img/dubai-metro-cbtc-driverless-network-fig1.png)
*<small>Dubai grew one homogeneous GoA 4 network to roughly 90 route-km on a single Thales SelTrac CBTC platform, without a legacy cutover.</small>*



![Dubai's two-line network on one Thales SelTrac platform, driverless from day one.](/blog/img/dubai-metro-cbtc-driverless-network-fig2.svg)
*<small>Dubai's two-line network on one Thales SelTrac platform, driverless from day one.</small>*

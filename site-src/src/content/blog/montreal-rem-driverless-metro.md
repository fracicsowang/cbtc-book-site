...
![The REM grew from a 16.6 km shuttle to a roughly 67 km network in under four years by adding track to one automated Alstom platform.](/blog/img/montreal-rem-driverless-metro-fig1.png)
*<small>The REM grew from a 16.6 km shuttle to a roughly 67 km network in under four years by adding track to one automated Alstom platform.</small>*



![The REM's four automated branches on a single Alstom Urbalis 400 platform.](/blog/img/montreal-rem-driverless-metro-fig2.svg)
*<small>The REM's four automated branches on a single Alstom Urbalis 400 platform.</small>*

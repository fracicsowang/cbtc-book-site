---
title: "RFP Red Flags: 8 Vendor Responses That Should Worry You"
slug: rfp-red-flags-vendor-responses
description: "Eight specific patterns in a Communications-Based Train Control proposal that should slow a US transit agency's evaluation team — drawn from twenty years of CBTC procurement review experience."
date: 2026-08-03
author: "Chunjun (Francisco) Wang"
category: procurement
tags: [CBTC, RFP, procurement, vendor evaluation, US transit, due diligence]
primary_keyword: "CBTC RFP red flags"
secondary_keywords: ["CBTC vendor evaluation", "CBTC bid review", "CBTC proposal warning signs", "CBTC procurement due diligence", "evaluating CBTC bids"]
related_chapters: [12, 15]
internal_links: ["/blog/evaluating-cbtc-bids-12-criteria", "/blog/cbtc-rfp-vendor-lockin", "/blog/cbtc-projects-over-budget"]
og_image: "/blog/img/rfp-red-flags-vendor-responses.png"
read_time: "9 min"
---
...
![If a proposal's master schedule is 25 percent shorter than the manuscript and US precedent suggest, the schedule is the red flag.](/figures/fig_12_05_testing_timeline.png)
*<small>If a proposal's master schedule is 25 percent shorter than the manuscript and US precedent suggest, the schedule is the red flag.</small>*
...
The Interface Control Document (ICD) is the contract between two subsystems. Manuscript Chapter 12 and the companion procurement piece on [How to Write a CBTC RFP That Doesn't Lock You Into One Vendor](/blog/cbtc-rfp-vendor-lockin) cover why ICDs matter for vendor neutrality. The diagnostic in a proposal: read the bidder's response to the ICD ownership clause. Three patterns are common.
...
![Two red flags in the same proposal predict a difficult contract. Three is grounds for an evaluation downgrade.](/blog/img/rfp-red-flags-vendor-responses-fig1.svg)
*<small>Two red flags in the same proposal predict a difficult contract. Three is grounds for an evaluation downgrade.</small>*
...
This post is a 9-minute checklist. The procurement framework that supports it lives in Chapter 12 (Project Lifecycle) and Chapter 15 (Vendor Landscape) of *Communications-Based Train Control*, Volume 2: Operations, Deployment & Economics ([Buy on Amazon](https://www.amazon.com/dp/B0GYHLYQZZ)). [Download Chapter 12 slides (free PDF)](https://cbtcbook.com/slides/cbtc_ch12.pdf) for the procurement structure and design-review framework.

For the 12-criterion evaluation rubric the eight flags slot into, see [Evaluating CBTC Bids: The 12 Criteria That Matter](/blog/evaluating-cbtc-bids-12-criteria). For the budget-overrun mechanics that the flags predict, see [Why CBTC Projects Run 30%+ Over Budget — and How to Prevent It](/blog/cbtc-projects-over-budget).

## Sources

- Wang, C. (2026). *Communications-Based Train Control, Volume 2: Operations, Deployment & Economics*. Independent. ISBN 979-8-258-54295-3. — Chapter 12, "Project Lifecycle," sections 12.2 and 12.4–12.5; Chapter 15, "Vendor Landscape."

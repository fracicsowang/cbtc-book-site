---
title: "Funding a CBTC Project: FTA, Federal, State, and Local Sources"
slug: funding-cbtc-fta-federal-state-local
description: "How US transit agencies actually fund Communications-Based Train Control deployments — Capital Investment Grants, TIFIA loans, state bonds, local match, and the funding-stack structure that survives FTA review."
date: 2026-07-26
author: "Chunjun (Francisco) Wang"
category: procurement
tags: [CBTC, funding, FTA, CIG, TIFIA, BIL, US transit, capital plan]
...
![A representative US CBTC funding stack. CIG is the dominant federal source; TIFIA, state, and local contributions complete the package.](/figures/fig_14_04_funding_stack.png)
*<small>A representative US CBTC funding stack. CIG is the dominant federal source; TIFIA, state, and local contributions complete the package.</small>*
...
<figure class="blog-figure blog-figure--table">
  <table class="blog-table">
    <thead>
      <tr><th>Funding Source</th><th>Eligibility</th><th>Federal Share</th><th>Typical Award Size</th></tr>
    </thead>
    <tbody>
      <tr><td>CIG - New Starts</td><td>New fixed-guideway projects above $400 million or $150 million in federal funding</td><td>Up to 60%</td><td>—</td></tr>
      <tr><td>CIG - Small Starts</td><td>New fixed-guideway projects capped at $400 million or $150 million in federal funding</td><td>—</td><td>—</td></tr>
      <tr><td>CIG - Core Capacity</td><td>Projects increasing capacity of existing systems</td><td>50-60%, sometimes higher</td><td>$2.2 billion annually (FY 2022-2026)</td></tr>
      <tr><td>TIFIA</td><td>Projects of regional and national significance</td><td>Up to 49% with dedicated revenue, 33% without</td><td>—</td></tr>
      <tr><td>RAISE</td><td>Projects of national or regional significance</td><td>—</td><td>$5 million to $50 million</td></tr>
      <tr><td>MEGA</td><td>Large-scale projects of national or regional significance</td><td>—</td><td>$100 million and up</td></tr>
    </tbody>
  </table>
  <figcaption class="blog-figure__caption">Multiple federal funding sources can contribute to a US CBTC funding stack. CIG is the dominant grant source; TIFIA is t</figcaption>
</figure>
...
This piece is the funding-stack walkthrough. The full Capital Investment Grant and lifecycle cost framework lives in Chapter 14 of *Communications-Based Train Control*, Volume 2 ([Buy on Amazon](https://www.amazon.com/dp/B0GYHLYQZZ)). [Download Chapter 14 slides (free PDF)](https://cbtcbook.com/slides/cbtc_ch14.pdf).

For the all-in CAPEX picture that the funding stack must cover, see [CBTC Procurement: Cost Drivers Beyond the Sticker Price](/blog/cbtc-procurement-cost-drivers). For the discounted lifecycle cost model that supports the BCR derivation, see [CBTC Lifecycle Cost: A 30-Year Model Walk-Through](/blog/cbtc-lifecycle-cost-30-year-model).
...
- US Department of Transportation. *Bipartisan Infrastructure Law (Infrastructure Investment and Jobs Act, P.L. 117-58)*. [transportation.gov/bipartisan-infrastructure-law](https://www.transportation.gov/bipartisan-infrastructure-law)
- Build America Bureau, US Department of Transportation. *TIFIA Program Overview*. [transportation.gov/buildamerica/financing/tifia](https://www.transportation.gov/buildamerica/financing/tifia)

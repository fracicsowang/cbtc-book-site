...
[FIGURE: Architecture comparison showing ETCS Level 2 (GSM-R radio, eurobalise, RBC, track circuits/axle counters) and CBTC (DCS radio access points, balise, zone controller, optional track circuit fallback) side by side.
Source: new figure to be generated.
Caption: "ETCS Level 2 retains track-circuit-based detection; CBTC replaces it with onboard position reporting."]

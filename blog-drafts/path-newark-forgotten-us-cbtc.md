...
[FIGURE: Three northeastern US transit systems with non-standard train control posture — PATH (FRA heavy-rail with PTC), PATCO (GoA 1 with CBTC advisory), Newark City Subway (legacy light rail without modernization) — with their respective regulatory and architectural status. Source: new figure to be generated. Caption: "PATH, PATCO, and the Newark City Subway: three forgotten northeastern systems on distinct modernization pathways."]
...
[FIGURE: Decision matrix mapping US transit system characteristics (FRA versus FTA jurisdiction, ridership density, network length, signaling vintage) to appropriate train control modernization pathways (PTC, partial CBTC, full CBTC GoA 2, full CBTC GoA 4). Source: new figure to be generated. Caption: "Train control modernization pathway depends on regulatory jurisdiction, ridership density, and network characteristics."]

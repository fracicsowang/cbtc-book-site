...
[FIGURE: Skill-transfer matrix mapping common software-engineering specializations (embedded, distributed systems, web/full-stack, ML/data, cybersecurity, RF/networking) to CBTC subsystems (VOBC, Zone Controller, ATS, DCS, analytics) with shading indicating clean transfer, partial transfer, or significant gap.
Source: new figure to be generated.
Caption: "Most modern software engineering specializations map cleanly onto one or two CBTC subsystems."]

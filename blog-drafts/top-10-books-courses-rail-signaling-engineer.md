...
[FIGURE: Reading-list flowchart organized by reader profile (new graduate, lateral transfer, agency engineer, procurement engineer) with an arrow from each profile to the three or four items on the list that are most relevant first.
Source: new figure to be generated.
Caption: "The reading list is not linear. Different starting points, different first reads."]

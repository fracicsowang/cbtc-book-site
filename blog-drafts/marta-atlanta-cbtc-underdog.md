---
title: "MARTA Atlanta CBTC: The Underdog US Deployment"
slug: marta-atlanta-cbtc-underdog
description: "An honest read of the Metropolitan Atlanta Rapid Transit Authority's signaling status: where the system actually sits on the CBTC pathway, what its partial automation deployment teaches mid-sized agencies, and the modernization opportunity Atlanta still has."
date: 2026-05-09
author: "Chunjun (Francisco) Wang"
category: agency-case-studies
tags: [CBTC, MARTA, Atlanta, US transit, signaling modernization, GoA 1]
primary_keyword: "MARTA Atlanta CBTC"
secondary_keywords: ["MARTA signaling modernization", "Atlanta MARTA train control", "MARTA CBTC plan", "GoA 1 US transit", "mid-sized agency CBTC"]
related_chapters: [2, 10, 12]
internal_links: ["/blog/wmata-cbtc-aspirations", "/blog/cbtc-rfp-vendor-lockin", "/blog/cbtc-vs-traditional-signaling-8-differences"]
og_image: "/blog/img/marta-atlanta-cbtc-underdog.png"
read_time: "11 min"
---
...
[FIGURE: Spectrum of US transit signaling modernization postures from 1979-vintage fixed-block (no modernization) through partial ATP retrofit and overlay-CBTC to full CBTC and GoA 4, with MARTA's GoA 1 partial position marked. Source: new figure to be generated. Caption: "MARTA's partial-modernization posture sits between legacy fixed-block and full CBTC retrofit."]
...
[FIGURE: Comparison matrix of MARTA's mid-sized profile against MTA (large multi-line), BART (large full-replacement), Baltimore (small single-line bundled), and HART Honolulu (greenfield GoA 4) — with shared and distinct procurement considerations. Source: new figure to be generated. Caption: "MARTA's mid-sized profile sits between large-network and small-agency procurement archetypes."]
...
This post is an 11-minute summary. The full treatment lives in Chapter 10 ("CBTC in the United States") and Chapter 12 ("Project Lifecycle") of *Communications-Based Train Control* (Volume 2). [Buy on Amazon](https://www.amazon.com/dp/B0GYHLYQZZ). [Download Chapter 10 slides (free PDF)](https://cbtcbook.com/slides/cbtc_ch10.pdf).
...
- Metropolitan Atlanta Rapid Transit Authority. *Capital Improvement Program*. [itsmarta.com](https://www.itsmarta.com/)

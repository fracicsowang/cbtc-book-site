...
internal_links: ["/blog/what-is-a-zone-controller", "/blog/onboard-side-of-cbtc-vobc", "/blog/cbtc-glossary-50-terms"]
...
[FIGURE: Side-by-side block diagram of Trainguard MT and Urbalis architectures, showing onboard, wayside, ATS, and DCS layers and the granularity of the Zone Controller / Object Controller boundary. Source: new figure to be generated. Caption: "Both platforms implement the same reference architecture with different boundary placement; Trainguard MT centralizes wayside logic, Urbalis distributes it."]
...
[FIGURE: Comparative wayside layout for a hypothetical 12-mile US metro line under Trainguard MT (3 ZCs, centralized) and Urbalis (12 Object Controllers, distributed), with notional cost-of-cable and cost-of-vital-computer overlays. Source: new figure to be generated. Caption: "The wayside architecture is the most consequential point of divergence between Trainguard MT and Urbalis."]

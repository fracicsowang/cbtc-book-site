...
The network opened as two lines. The Red Line runs roughly 67 kilometers with 35 stations along the Sheikh Zayed Road spine; the Green Line adds about 22.5 kilometers and 20 stations through the older urban core. That combined length was enough to earn the 2009 Guinness World Record for the longest fully automated metro, a title Dubai held until 2016 and reclaimed in 2021.
...
[FIGURE: Bar chart of the Dubai Metro network by segment and opening year, showing route length in kilometers. DATA: Red Line (2009)=67, Green Line (2011)=22.5, Route 2020 ext. (2021)=15. Caption: "Dubai extended one homogeneous GoA 4 network — roughly 104 route-km on a single Thales SelTrac CBTC platform — without a legacy cutover."]

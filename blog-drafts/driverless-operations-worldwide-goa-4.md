...
[FIGURE: Global GoA 4 metro map and table showing the systems above with route-km, opening year, vendor, and GoA grade. Differentiated visually from GoA 3 systems with on-board attendants. Source: new figure to be generated derived from Chapter 11 manuscript Table 11.3 and Chapter 8 GoA 4 catalog. Caption: "Approximately 75–80 lines globally operate at full UTO. The rest are GoA 3 or lower, regardless of marketing."]
...
[FIGURE: GoA grade comparison decision matrix. Rows: on-board staff role, platform screen doors, labor cost per train-km, safety case framework, regulatory pathway, public acceptance. Columns: GoA 2 (driver in cab), GoA 3 (no driver, on-board attendant), GoA 4 (UTO, no on-board staff). Source: new figure to be generated derived from Chapter 8 manuscript framework. Caption: "GoA 2, GoA 3, and GoA 4 are different products with different cost and safety case implications."]

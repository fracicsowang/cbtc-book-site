...
[FIGURE: Singapore MRT GoA 4 line family — North-East Line (2003, Alstom, 20 km), Circle Line (2009 onward, Thales SelTrac), Downtown Line (2013, Siemens Trainguard MT), Thomson-East Coast Line (2020–2024 phased, Hitachi Rail STS). Each line marked with opening year, route-km, vendor, peak headway. Source: new figure to be generated. Caption: "LTA's GoA 4 portfolio is multi-vendor by design. The architectural standard is the operating concept, not the supplier."]

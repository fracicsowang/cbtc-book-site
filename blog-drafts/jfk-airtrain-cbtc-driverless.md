...
[FIGURE: JFK AirTrain network map showing 8.1-mile guideway with three service routes (Howard Beach, Jamaica, central terminal circulator), platform screen door integration, and wayside CBTC infrastructure. Source: new figure to be generated. Caption: "JFK AirTrain network: three routes, 8.1 miles, operating GoA 4 since December 2003."]
...
[FIGURE: Comparison table of factors driving GoA 4 adoption in US airport APMs (mission alignment, regulatory clarity, technology maturity, capital efficiency) versus the additional constraints urban transit faces (labor agreements, equity and accessibility considerations, mixed operating environments, brownfield retrofit). Source: new figure to be generated. Caption: "Airport APMs operate under conditions distinct from urban transit; the GoA 4 saturation in airports does not directly transfer to urban metro retrofit."]

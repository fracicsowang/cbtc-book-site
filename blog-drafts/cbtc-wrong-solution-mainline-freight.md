...
[FIGURE: Side-by-side comparison of US freight and US metro operating profiles, plotting train length, train weight, trains per day, route-miles, network density, and capital cost per route-mile.
Source: new figure to be generated.
Caption: "The US freight and US metro networks differ on every operational dimension that drives train control technology choice."]

...
[FIGURE: Bar chart of typical US CBTC project cost growth by driver category (scope, cutover, testing, BABA, ISA, change orders, training), with median percentage of original contract value contributed by each.
Source: new figure to be generated.
Caption: "Cost growth on US CBTC projects is rarely a single failure. It accumulates across seven recurring driver categories."]

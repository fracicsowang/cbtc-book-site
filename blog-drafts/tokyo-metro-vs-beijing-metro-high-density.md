...
[FIGURE: Tokyo Metro vs Beijing Subway snapshot — route-kilometers (195 vs 800), lines (9 vs 27), peak headway (110s Marunouchi vs 120s Beijing Line 4), signaling platform mix (ATC family with CBTC pilots vs CBTC-default with GoA 4 expansion), vendor mix (Mitsubishi/Hitachi/Toshiba domestic vs early-foreign-then-domestic CRSC/CASCO/TCT). Source: new figure to be generated. Caption: "Same operational outcome at urban scale; profoundly different signaling modernization paths."]
...
[FIGURE: Tokyo–Beijing modernization path comparison. Tokyo: incremental ATC evolution (ATC-2 → ATC-6 → ATC-10 → selective CBTC pilots) over 1960s–2020s with high institutional continuity. Beijing: CBTC default since 2007 plus GoA 4 pilots from 2017, multi-vendor including CRSC, CASCO, TCT domestic. Source: new figure to be generated. Caption: "Two reasonable answers to the same problem. Each reflects the institutional context that produced it."]

...
[FIGURE: Stacked bar chart of CBTC vendor lock-in cost across the 30-year asset life, decomposed into initial procurement premium, refresh procurement premium, spares and support premium, cross-line expansion premium, and operational embedding cost.
Source: new figure to be generated.
Caption: "Lock-in cost is the sum of five recurring premiums across a 30-year asset life. The largest component is cross-line expansion, not initial procurement."]
...
[FIGURE: Decision tree for the bundled vs. unbundled CBTC procurement choice, with the lock-in premium and operational complexity tradeoffs at each branch.
Source: new figure to be generated.

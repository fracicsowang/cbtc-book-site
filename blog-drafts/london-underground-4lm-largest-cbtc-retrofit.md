...
[FIGURE: 4LM scope schematic showing the four lines (Circle, District, Hammersmith & City, Metropolitan) overlaid on the London Underground network, with the central shared core highlighted and the legacy signaling, S-Stock fleet, and Thales SelTrac CBTC layers indicated. Source: new figure to be generated. Caption: "4LM is the largest CBTC retrofit ever awarded by route-kilometers, and the underlying infrastructure is the oldest."]
...
[FIGURE: 4LM delivery timeline from 2011 contract award to Bombardier, 2013 termination, 2014 re-tender, 2015 Thales contract award, Stage 1 revenue service (Hammersmith & City and Circle), through 2027 target full revenue across all four lines. Compared against the NYC L Line 12-year program and the BART Train Control Modernization Program (TCMP) timeline. Source: new figure to be generated. Caption: "Multi-line brownfield CBTC retrofits run on multi-decade calendars. 4LM is the largest, and the schedule shows it."]

...
[FIGURE: Line or stacked-area chart — indicative, not measured — of how a US CBTC engineer's working competency accumulates over the first six years, attributed to four sources. DATA (illustrative share of working competency, percent): Year 1 — university 55, vendor 25, continuing-education 10, on-the-job 10; Year 2 — university 35, vendor 30, continuing-education 10, on-the-job 25; Year 4 — university 20, vendor 25, continuing-education 15, on-the-job 40; Year 6 — university 10, vendor 20, continuing-education 15, on-the-job 55. Caption: "Indicative only — the pattern, not the numbers, is the point. The university share of working competency declines as supervised field experience compounds, and on-the-job apprenticeship becomes the dominant source by roughly year four."]

## Standards literacy: reading IEEE 1474 and IEC 62290 for yourself

The one form of CBTC training an engineer can begin alone, at no cost beyond the price of the documents, is reading the standards. IEEE Std 1474.1 defines the performance and functional requirements for a CBTC system — high-resolution train location independent of track circuits, continuous bidirectional train-to-wayside data communication, and vital onboard and wayside processors implementing automatic train protection, with optional automatic train operation and supervision. First issued in 2004 and revised since, it is the vocabulary every US specification is written in. The international counterpart, the IEC 62290 series on urban guided transport management and command and control systems, defines the grades of automation from GoA 1 through unattended GoA 4 that structure any conversation about driverless operation.

...
[FIGURE: Comparison table summarizing the eight differences across separation, detection, capacity, safety, infrastructure, cost, degraded mode, and supplier landscape.
Source: new figure to be generated.
Caption: "The eight axes on which CBTC and traditional signaling diverge, with US deployment data points."]

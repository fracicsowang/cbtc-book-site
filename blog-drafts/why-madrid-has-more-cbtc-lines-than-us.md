---
title: "Why Madrid Metro Has More CBTC Lines Than the Entire US"
slug: why-madrid-has-more-cbtc-lines-than-us
description: "A practitioner read of how Metro de Madrid built a 12-line Communications-Based Train Control portfolio across roughly 290 route-kilometers — more CBTC lines than every US transit agency combined. What this means for US agencies that face structurally different cost, calendar, and institutional conditions."
date: 2026-05-09
author: "Chunjun (Francisco) Wang"
category: international-benchmarks
tags: [CBTC, Madrid Metro, Spain, Siemens, Bombardier, Barcelona Metro, Valencia Metro, international, comparative]
...
[FIGURE: Madrid Metro CBTC line family — Lines 1 through 12 plus ML1 light metro, with vendor (Siemens or Bombardier/Alstom Urbalis), GoA grade, and approximate deployment year for each line. Compared on the same chart with US CBTC deployments by line count (NYCT L, NYCT 7, NYCT Queens Boulevard partial, BART partial, Muni partial, Honolulu Skyline). Source: new figure to be generated. Caption: "Madrid Metro alone operates more CBTC lines than every US transit agency combined."]
...
[FIGURE: Mechanisms transferable from the Madrid Metro CBTC pattern to US transit. Three columns: standardized architectural baseline across procurements (transferable, US application: program-level specification document), multi-vendor competition preservation (transferable, US application: deliberate two-vendor procurement strategy on multi-line programs), permanent agency-level CBTC engineering staff (transferable, US application: investment in 20–40 FTE CBTC group at major operators). Source: new figure to be generated. Caption: "What transfers from Madrid is the institutional pattern, not the cost or the calendar."]
...
- Metro de Madrid. *Network and Operations*. [metromadrid.es](https://www.metromadrid.es)
- Transports Metropolitans de Barcelona (TMB). *Barcelona Metro Operations*. [tmb.cat](https://www.tmb.cat)
- Metrovalencia (Ferrocarrils de la Generalitat Valenciana). *Valencia Metro Operations*. [metrovalencia.es](https://www.metrovalencia.es)
...
- Railway Gazette International. *Madrid and Barcelona Metro Reporting*. [railwaygazette.com](https://www.railwaygazette.com)
- International Railway Journal (IRJ). *European Metro Coverage*. [railjournal.com](https://www.railjournal.com)
- Siemens Mobility. *Trainguard MT References Worldwide*. [siemens.com/global/en/products/mobility](https://www.siemens.com/global/en/products/mobility)

...
const BOOK = {
  ...
  v1: {
    ...
    chapters: [
      ["01", "The Evolution of Train Control"],
      ["02", "Standards & Regulations: US Framework"],
      ["03", "CBTC System Architecture Overview"],
      ["04", "Onboard Equipment"],
      ["05", "Wayside Equipment"],
      ["06", "Communication Systems"],
      ["07", "Central System / ATS"],
    ],
  },
  v2: {
    num: "02", roman: "TWO",
    ...
    pricePrint: "$54.95",
    priceKindle: "$24.95",
    blurb: "From architecture to practice. The GoA 0–4 framework, operating modes, and hard-won lessons of US deployments — New York MTA, San Francisco BART — benchmarked against London, Paris, and Asia. Project lifecycle, performance criteria, lifecycle cost analysis, and a clear-eyed map of the vendor landscape.",
    chapters: [
      ["08", "Grades of Automation"],
      ["09", "Operating Modes"],
      ["10", "CBTC in the United States"],
      ["11", "International Benchmarks"],
      ["12", "Project Lifecycle"],
      ["13", "Performance Criteria"],
      ["14", "Lifecycle Costs"],
      ["15", "Vendor Landscape"],
      ["16", "US–China Comparative Perspectives"],
    ],
  },
};
